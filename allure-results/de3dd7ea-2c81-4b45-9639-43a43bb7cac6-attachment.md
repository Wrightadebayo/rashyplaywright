    ...
    - iframe [ref=e176]:
      - generic [ref=f1e2]:
        ...
        - generic [ref=f1e56]:
          ...
          - generic [ref=f1e124]:
            - generic [ref=f1e126]:
              - heading "Featured Courses" [level=2] [ref=f1e128]
              - generic [ref=f1e131] [cursor=pointer]:
                - generic: Dollar($) Rupee(₹)
            - link "VIEW ALL COURSES" [ref=f1e134] [cursor=pointer]:
              - /url: https://courses.rahulshettyacademy.com/courses
        - generic [ref=f1e137]:
          - generic [ref=f1e138]:
            - heading "JOIN OUR ACADEMY" [level=2] [ref=f1e139]
            - generic [ref=f1e140]: Sign up today and get access to "Core Java for Testers" & "QA Resume Preparation" Courses for FREE.
          - link "JOIN NOW" [ref=f1e143] [cursor=pointer]:
            - /url: https://courses.rahulshettyacademy.com/sign_up
        - contentinfo [ref=f1e144]:
          - generic [ref=f1e147]:
            - generic [ref=f1e149]:
              - text: All Right Reserved
              - link "RahulShettyAcademy" [ref=f1e150] [cursor=pointer]:
                - /url: "#"
              - text: ©
            - list [ref=f1e152]:
              - listitem [ref=f1e153]:
                - link "About Us" [ref=f1e154] [cursor=pointer]:
                  - /url: /about-my-mission
              - listitem [ref=f1e155]:
                - link "Contact Us" [ref=f1e156] [cursor=pointer]:
                  - /url: contact-us
              - listitem [ref=f1e157]:
                - link "Privacy Policy" [ref=f1e158] [cursor=pointer]:
                  - /url: /privacy
        - text: 
  - table [ref=e178]:
    - rowgroup [ref=e179]:
